      ...
      <div className="top-footer">
        ...
        <div className="about">
          <h2>
            <a
              ...
              href="https://github.com/michael-gann/Petsy/wiki"
              target="_blank"
            >
              About
            </a>
          ...
          <h4>
            <a
              rel="noopener noreferrer"
              href="https://github.com/michael-gann/Petsy/blob/master/readme.md"
              target="_blank"
            >
              Project README
            </a>
          ...
          <h4>
            <a
              rel="noopener noreferrer"
              href="https://github.com/michael-gann/Petsy/wiki/6.-Database-Schema"
              target="_blank"
            >
        ...
        <div className="team">
          ...
          <h4>
            ...
            <a
              rel="noopener noreferrer"
              href="https://github.com/nappernick"
              target="_blank"
            >
              <i class="fab fa-github-alt"></i>
            </a>
