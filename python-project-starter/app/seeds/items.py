...
There’s nothing prickly about this cool Frisco Cactus Cat Scratching Post! This sisal scratching post is designed to stand up to the power of playtime, and the stable baseboard allows your cactus kitty to stretch, paw, scratch, and climb all day with total support. The top and bottom of the cactus feature a moppy fabric plush material that feels great for cats to nuzzle. This fun cactus shape adds a cute design element to your home, plus it’s super easy to assemble.''', price=95.20, imgurl='https://img.chewy.com/is/image/catalog/214357_MAIN._AC_SL400_V1606832412_.jpg', categoryId=2)
    ...
    demo18 = Item(sellerId=3, name='''New Age Pet Ecoflex InnPlace Crate''', description='''It is the perfect place for your pet when indoors. This ecoFLEX Crate End Table can easily do double duty in many houses where it can serve as an end table in the family room''', price=48.60, imgurl='https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQdpwcx7ljWSnBJF8o6GIdB6HohvXWNm9vH_yvdIyw_HfAydOB328gDgqTfTb0Ktu_yHg60XUa_3QehF_pwe-KfKiZpG5Gy-fiwbueM3CYhQL00MpfOMpVmkQ&usqp=CAE', categoryId=2)

    demo19 = Item(sellerId=5, name='''Pet Zone IQ Treat Ball''', description='''The Pet Zone IQ Ball provides a challenging way to dispense treats. ''', price=24.99, imgurl='https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcTBYoApRdSA3DtBEff_2d6eTsZcJ6UUIILAUp-XEEv7bQyZ7WAnRYlp9-xFzYD6Yrc0RduSYtEteLDBqDAitRKwHqndFWTB5S73-aQcOG8yCcLCKN-rAHkq&usqp=CAE', categoryId=2)
