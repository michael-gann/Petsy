...
def seed_reviews():
    ...
    demo_review6 = Review(userId=1, itemId=6, score=4, review='''Super stylish bandana! The listing says its for dogs but my cat is still swagging in it!''')
    demo_review7 = Review(userId=2, itemId=7, score=5, review='''Wow, these yak treats hit different! My dog just cant get enough of them, he's actually been listening! Definitely a life changer and saver!''')
    demo_review8 = Review(userId=3, itemId=8, score=5, review='''Purchased this for my kitten since it was their birthday, and they love it! Been playing with it all day, I think they forgot I exist anymore!''')
    demo_review9 = Review(userId=4, itemId=9, score=4, review='''This climbing tree is the best! Foundation is strong, and my cat is scartching it nonstop! Great buy!''')
    demo_review10 = Review(userId=5, itemId=10, score=3, review='''HIGHLY recommend this dog bed, its super soft and well made! Quality material and will keep your furry friends warm and cozy!''')
